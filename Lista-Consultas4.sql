...
-- produto cartesiano, pouco eficiente porque cria uma tabela com N tuplas 
-- sendo N o produto das tuplas das duas tabelas
...
-- bem mais eficiente!!!
--select distinct c.nome_cliente, cidade_cliente
--from emprestimo e 
--    inner join cliente c
--    on c.nome_cliente = e.nome_cliente;
...
select E.NOME_CLIENTE, E.NOME_AGENCIA, E.NUMERO_CONTA,
        SUM(D.SALDO_DEPOSITO) as depositos, SUM(E.VALOR_EMPRESTIMO) as emprestimos, 
